    ...
    >
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          title="No CVs yet"
          message="Create your first CV from scratch, upload an existing one, or let Tenun generate a first draft tailored to your target role."
          action={{ label: "Create your first CV", href: "/dashboard/cv/new" }}
        />
      ) : (
              ...
              <div className="flex items-start gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    ...
                    <span className="text-[10px] text-navy-400">Updated {formatDate(cv.updated_at)}</span>
                  </div>
                </div>
              </div>
